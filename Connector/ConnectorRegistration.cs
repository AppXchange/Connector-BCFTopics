namespace Connector;
using Connector.BCF21.v1;
using Connector.BCF30.v1;
...
public class ConnectorRegistration : IConnectorRegistration<ConnectorRegistrationConfig>, IConfigureConnectorApiClient
{
    ...
    {
        serviceCollection.AddSingleton<IConnectorServiceDefinition, BCF30V1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, BCF30V1CacheWriterServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, BCF21V1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, BCF21V1CacheWriterServiceDefinition>();
    }
