...
public class CreateTopicsBatchHandler : IActionHandler<CreateTopicsBatchAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateTopicsBatchActionOutput>();
            // response = await _apiClient.PostTopicsBatchDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetTopicsBatchDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateTopicsBatchActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(TopicsBatchDataObject), CacheChanges = operations.ToArray() }
            };
