...
public class UpdateProjectExtensionsHandler : IActionHandler<UpdateProjectExtensionsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateProjectExtensionsActionOutput>();
            // response = await _apiClient.PostProjectExtensionsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetProjectExtensionsDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateProjectExtensionsActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(ProjectExtensionsDataObject), CacheChanges = operations.ToArray() }
            };
