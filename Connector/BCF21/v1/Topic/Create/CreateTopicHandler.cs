...
namespace Connector.BCF21.v1.Topic.Create;
...
public class CreateTopicHandler : IActionHandler<CreateTopicAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateTopicActionOutput>();
            // response = await _apiClient.PostTopicDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetTopicDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateTopicActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { nameof(CreateTopicHandler) };
