...
/// are intended to be.
/// </summary>
[Description("Creates a new Topic for the specified Trimble Connect Project")]
public class CreateTopicAction : IStandardAction<CreateTopicActionInput, CreateTopicActionOutput>
{
    public CreateTopicActionInput ActionInput { get; set; } = new() 
    { 
        Title = string.Empty,
        TopicType = string.Empty,
        TopicStatus = string.Empty
    };
    public CreateTopicActionOutput ActionOutput { get; set; } = new() { Guid = string.Empty };
