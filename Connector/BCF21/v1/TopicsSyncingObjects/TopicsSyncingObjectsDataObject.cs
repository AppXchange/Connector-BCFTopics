...
/// <summary>
/// Data object that represents the syncing objects response from BCF 2.1
/// </summary>
[PrimaryKey("changeToken", nameof(ChangeToken))]
[Description("Represents the syncing objects response from BCF 2.1")]
public class TopicsSyncingObjectsDataObject
{
