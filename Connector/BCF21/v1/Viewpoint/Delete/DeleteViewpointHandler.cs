...
public class DeleteViewpointHandler : IActionHandler<DeleteViewpointAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteViewpointActionOutput>();
            ...
            // var resource = new DeleteViewpointActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(ViewpointDataObject), CacheChanges = operations.ToArray() }
            };
